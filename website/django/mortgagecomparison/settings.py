...
#SECRET_KEY = 'lsc-yd*62y@sjq6#b%sol)vh+e9d^w(bsw^6%up@814$rau54t'
SECRET_KEY = 'h(*QE*HVKvhhhdsv0qe*A)DSVYADVH0a)A)S)AS(VAS)&ASC&^'
...
# Only put cacheing on if we're live
if LIVE == True:
	CACHES = {
	    'default': {
